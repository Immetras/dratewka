...
export default [
  [
    ...
    new Location("A hill", [1, 3], "rgb(117,237,243)", "1110", [31]),
    new Location("Some bushes", [1, 4], "rgb(202,230,51)", "1010", []),
    new Location("An old deserted hut", [1, 5], "rgb(220,204,61)", "1010", [27]),
    new Location("The edge of a forest", [1, 6], "rgb(167,245,63)", "1010", []),
    new Location("A dark forest", [1, 7], "rgb(140,253,99)", "1100", [14]),
  ],

  [
    new Location("A man nearby making tar", [2, 1], "rgb(255,190,99)", "0110", []),
    new Location("A timber yard", [2, 2], "rgb(255,190,99)", "1110", []),
    new Location("You are by a roadside shrine", [2, 3], "rgb(167,245,63)", "1111", [10]),
    ...
    new Location("You are in a deep forest", [2, 7], "rgb(140,253,99)", "1001", [18]),
  ],

  [
    new Location("You are by the Vistula River", [3, 1], "rgb(122,232,252)", "0011", []),
    new Location("You are by the Vistula River", [3, 2], "rgb(140,214,255)", "1001", [32]),
  ...
  [
    ...
    new Location("You are by the water mill", [4, 4], "rgb(255,190,99)", "0010", [21]),
